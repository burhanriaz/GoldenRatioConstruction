...
@Component({
  selector: 'app-arabic-service',
  imports: [ArabicnarComponent,NgFor,FooAComponent,ArabicCounterComponent],
  templateUrl: './arabic-service.component.html',
  styleUrl: './arabic-service.component.css'
})
export class ArabicServiceComponent {
services = [
  {
